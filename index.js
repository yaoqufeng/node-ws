...
const UUID = process.env.UUID || '5e5be77d-b937-4d0a-b1c8-159e5a3f8560'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.086571.xyz:443';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
...
const DOMAIN = process.env.DOMAIN || 'value-jp.gpt.us.kg';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const NAME = process.env.NAME || 'Value-jp';                       // 节点名称
const PORT = process.env.PORT || 50543;                     // http和ws服务端口
